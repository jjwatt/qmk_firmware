/* Copyright 2018 Jesse Wattenbarger
 *
...
enum ortho_5x15_layers {
  _QWERTY,
  _RAISE
};

enum ortho_5x15_keycodes {
  QWERTY = SAFE_RANGE,
};
...
[_QWERTY] = LAYOUT_ortho_5x15(
  ...
  KC_LCTL, KC_LGUI, KC_LALT, RAISE,   KC_SPC,  KC_SPC,  KC_LEFT, KC_DOWN, KC_RGHT, KC_SPC,  KC_SPC,  RAISE,   KC_RALT, KC_RGUI, KC_RCTL,
),
...
[_RAISE] = LAYOUT_ortho_5x15(
  ...
  _______, _______, RGB_TOG, RAISE,   RGB_RMOD,RGB_MOD, KC_P0,   _______, KC_PDOT, KC_PENT, KC_PENT, RAISE,   _______, _______, _______,
  )
};
